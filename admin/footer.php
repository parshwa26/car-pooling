<div class="footer">
			...
			<div class="footer-grids">
				...
				<div class="footer-grid">
					<h3>Basic Info.</h3>
					<ul>
						<li><a href="infoaboutus.php">About Us</a></li>
						<li><a href="trust1.php">Trust</a></li>
						<li><a href="choice1.php">Choice</a></li>
						<li><a href="insurance1.php">Insurance</a></li>
					</ul>
				</div>
				<div class="footer-grid">
					<h3>USEFUL INFO</h3>
					<ul>
						<li><a href="searchforride1.php">How to search for ride?</a></li>
						<li><a href="bookride1.php">How to book a ride?</a></li>
						<li><a href="payforride1.php">How to pay for ride?</a></li>
						<li><a href="tandc1.php">Terms And Condition </a></li>
					</ul>
				</div>

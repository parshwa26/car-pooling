...
<td>Enter E-Mail Id:
			...
			<?php if(isset($_SESSION['txt_emailerror'])){echo "<tr><td style=padding-left:50px; margin-left:50px;><font color=red>Enter Email</font></td></tr>";unset($_SESSION['txt_emailerror']);}?></table>
